package org.CharlesBorabon.OOP_Part2;
import org.CharlesBorabon.OOP_Part2.bank.BankCustomer;
import org.CharlesBorabon.OOP_Part2.management.Employee;
import org.CharlesBorabon.OOP_Part2.management.Management;
import org.CharlesBorabon.OOP_Part2.zoo.Zoo;
import org.CharlesBorabon.OOP_Part2.zoo.ZooAnimal;

public class Main {
    public static void main(String[] args) {
        // bank package test
        BankCustomer customer = new BankCustomer(111, "John Doe", 1000.00, "John Doe", "1234 Elm St", "555-555-5555", "joe@email.com");
        BankCustomer customer2 = new BankCustomer(222, "Jane Doe", 1000.00, "Jane Doe", "1234 Elm St", "555-555-5555", "jane@email.com");
        System.out.println(customer.toString());
        customer.deposit(500.00);
        System.out.println(customer.toString());
        customer.withdraw(200.00);
        System.out.println(customer.toString());
        customer.transfer(100.00, customer2);
        System.out.println(customer.toString());
        System.out.println();
